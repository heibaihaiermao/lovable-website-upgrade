...
export default function Features() {
  return (
    <div className="px-4 sm:px-6 md:px-8">
      {/* Section wrapper is transparent; global bg shows through */}
      <section className="py-20 transition-colors duration-500 relative overflow-hidden">

        {/* Inner card container with box styling */}
        <div className="max-w-7xl mx-auto bg-white dark:bg-gray-950 rounded-3xl shadow-2xl p-8">

          {/* Section header */}
          <div className="relative text-center mb-16">
            <h2 className="text-4xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">
              Everything you need to{' '}
              <span className="bg-gradient-to-r from-violet-600 to-blue-600 bg-clip-text text-transparent opacity-70">
                dominate SEO
              </span>
            </h2>
